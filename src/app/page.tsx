...
export default function Home() {
  ...
  return (
    <div className="fixed inset-0 bg-slate-50 flex overflow-hidden font-sans text-slate-900">
      ...
      <div className="fixed top-8 right-4 z-[700]">
        {!isAuthLoading && (
          authUser ? (
            ...
            <button onClick={handleGoogleLogin} className="flex items-center gap-2 bg-white shadow-xl rounded-2xl px-4 py-3 text-slate-600 text-xs font-black active:scale-95 transition-transform">
